...
pipe:lexicon("#personnageChamp", {"personnages", "personnage"})
...
pipe:lexicon("#colonisateur", {"colonisé", "colonisés", "colonises", "colonise", "colonisateur", "colonisateurs"})
pipe:lexicon("#colonisePar", {"colonisé par", "colonisés par", "colonises par", "colonise par"})
